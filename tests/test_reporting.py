    ...
    (tmp_path / "research_summary.md").write_text(
        "\n".join(
            [
                ...
                "",
                "- most_lcri_stable_scope: signal",
                "- most_lcri_stable_mean_raw_minus_lcri_gap: 0.030000",
                "",
                ...
                "| scope | context | raw_minus_lcri_directional_accuracy_gap |",
                "| --- | --- | --- |",
                "| regime | thin | -0.040000 |",
                "",
                "## LCRI gap delta scope extremes",
                "",
                "| scope | best_context | best_raw_minus_lcri_gap | worst_context | worst_raw_minus_lcri_gap |",
                "| --- | --- | --- | --- | --- |",
                "| signal | all | 0.030000 | all | 0.030000 |",
                "",
                "## LCRI gap delta scope summary",
                "",
                "| scope | rows | mean_raw_minus_lcri_gap | min_raw_minus_lcri_gap | max_raw_minus_lcri_gap | lcri_more_stable_share | lcri_less_stable_share |",
                "| --- | --- | --- | --- | --- | --- | --- |",
                "| signal | 1 | 0.030000 | 0.030000 | 0.030000 | 1.000000 | 0.000000 |",
                "",
                "## LCRI evidence lineage map",
                "",
                "| scope | lineage_status | handoff_status |",
                "| --- | --- | --- |",
                "| signal | complete | release_note_monitor |",
                "",
                ...
                "| scope | rows | warning_or_critical_share | critical_share |",
                "| --- | --- | --- | --- |",
                "| signal | 2 | 0.500000 | 0.000000 |",
                "",
                "## LCRI generalization scope gate decisions",
                "",
                "| scope | decision | required_action |",
                "| --- | --- | --- |",
                "| signal | watch | monitor warning contexts |",
                "",
